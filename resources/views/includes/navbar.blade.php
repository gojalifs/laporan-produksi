    ...
    <ul class="navbar-nav navbar-right">
        <li class="dropdown"><a href="#" data-toggle="dropdown"
            ...
            <div class="dropdown-menu dropdown-menu-right pullDown">
                ...
                <a href="{{ route('user-profile') }}" class="dropdown-item has-icon"> <i class="fas fa-user"></i>
                    Profile
                </a>
                <a href="javascript:void(0)" class="dropdown-item has-icon settingPanelToggle"> <i
                        class="fas fa-cog"></i>
                    Settings
                </a>
